...
func EditHomeAddress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		update := bson.D{{Key: "$set", Value: bson.D{primitive.E{Key: "address.0.house_name", Value: editaddress.House}, {Key: "address.0.street_name", Value: editaddress.Street}, {Key: "address.0.city_name", Value: editaddress.City}, {Key: "address.0.pin_code", Value: editaddress.Pincode}}}} // This is the update query to edit the address
		_, err = UserCollection.UpdateOne(ctx, filter, update)
		if err != nil {
...
func EditWorkAddress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		ctx.Done()
		c.IndentedJSON(200, "Work Address Updated Successfully")
	}
}
